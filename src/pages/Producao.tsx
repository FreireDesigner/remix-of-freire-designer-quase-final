  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="gradient-blue py-12 px-4 text-center wave-divider-blue">
        <span className="inline-block bg-[hsl(218,40%,50%)] text-white text-sm font-semibold px-4 py-2 rounded-full mb-6">
      ...
      <section className="py-8 px-4 bg-background">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="text-lg font-bold text-foreground">Galeria de Imagens - Etapa 01</h3>
        </div>
        <p className="text-sm text-muted-foreground mb-6">Clique nas imagens para visualizar em tamanho maior</p>
        ...
        <div className="space-y-4">
          <div className="bg-muted rounded-2xl overflow-hidden">
            <div className="aspect-video flex flex-col items-center justify-center bg-muted">
              ...
              <span className="text-sm font-bold text-muted-foreground">PEDIDO_WHATSAPP</span>
              <span className="text-xs text-muted-foreground">Adicione sua foto aqui</span>
            </div>
            <div className="p-4 bg-background border-t border-border">
              <span className="text-sm font-semibold text-foreground">Atendimento pelo WhatsApp</span>
            </div>
          </div>
          ...
          <div className="bg-muted rounded-2xl overflow-hidden">
            <div className="aspect-video flex flex-col items-center justify-center bg-muted">
              <Camera className="w-12 h-12 text-muted-foreground/50 mb-2" />
              <span className="text-sm font-bold text-muted-foreground">MODELOS_PRONTOS</span>
              <span className="text-xs text-muted-foreground">Adicione sua foto aqui</span>
            </div>
            <div className="p-4 bg-background border-t border-border">
              <span className="text-sm font-semibold text-foreground">Modelos Prontos</span>
            </div>
          </div>
        </div>
      </section>
